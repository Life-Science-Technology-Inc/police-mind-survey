...
- `src/components/DataCollectionGuide.js` 추가 수정
  ...
  - 실험 기간 표기를 `1차: 26. 5. 13(수) ~`, `2차: 26. 5. 27(수) ~`로 변경
...
- 희망 참여일 선택 문구 및 레이아웃 정리
  - `1차 실험(2026. 5. 13 ~)`, `2차 실험(2026. 5. 27 ~)`, `상관없음`으로 문구 통일
...
- 필드 가이드 이미지 자산 정리
  - `public/field-study-guide/` 아래로 드롭다운 메뉴 순서 기준 자산 재배치
  - 기존 중복 자산은 `public/old/`로 이동하고, 별도 페이지가 사용하는 `public/samsung_health_download/`는 유지
- 메인 페이지 정리
  - 상단 경찰청/한국과학기술연구원 로고 제거
  - 안내 문구의 연도를 `2026년도`로 수정
  - 상단 안내 박스 폭을 하단 3개 카드 라인과 맞도록 확장
